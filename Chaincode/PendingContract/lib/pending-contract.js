...
class PendingContract extends Contract {
    ...
    async instantiate(ctx) {
        ...
        let pending1 = Pending.createInstance('1234','5678', 'Bogdan Ilic', 'Opsta Bolnica Nis', 'Kardiohirurgija', 'Operacija srca', 'AB', 'CD', 'EF', [approver1],false, 5.0, []);
        let pending2 = Pending.createInstance('4444','5555', 'Darko Ilic', 'Dom Zdravlja', 'Ortopedija' , 'Operacija kolena' ,'AB', 'CD', 'EF', [approver1, approver2], false, 7.0, []);
        let pending3 = Pending.createInstance('4444','5555', 'Gari Nevil', 'Opsta bolnica Nis', 'Virusologija', 'Detoksikacija', 'GG', 'CD', 'EF', [approver1, approver2], false, 10.0, []);
