...
const os = require('os');
const SmartContractUtil = require('../functionalTests/js-smart-contract-util');
//const { FabricConnectingUtil } = require('../lib/fabric-connecting-util');
...
async function addPacientTest() {
    ...
    const responseBuf = await contract.evaluateTransaction('pacientExists', '000000003');

    // Disconecting from Gateway
    await gateway.disconnect();

    console.log(JSON.parse(responseBuf.toString()));
}
addPacientTest();